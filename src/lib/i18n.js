...
const diccionarios = {
  es: {
    ...
    'reportar.mapa_toggle': '🗺️ Marcar el punto exacto en el mapa',
    'reportar.mapa_ocultar': 'Ocultar el mapa',
    'reportar.mapa_ayuda': 'Arrastra el pin (o toca el mapa) a tu calle o edificio. Solo lo verá el coordinador que tome el caso; en el mapa público se muestra a nivel de sector.',
